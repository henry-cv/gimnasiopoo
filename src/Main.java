...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Actividad musculacionPlantaBaja = new Actividad(
      100,
      "Salon PB",
      "Luciano",
      "PB"
    );
    Actividad piletaLibreTarde = new Actividad(
      21,
      "Pileta libre por la tarde",
      "Erica",
      "Pileta olimpica"
    );
    Actividad karateConMarcos = new Actividad(
      8,
      "Clases de Karate",
      "Marcos",
    ...
    Socio martin = new SocioPorActividades(
      1,
      "Martin Sauczuk",
      //Creo una lista al vuelo
    ...
    SocioPorCantActividades andreaPack3clases = new SocioPorCantActividades(
      21,
      "Andrea",
      3
    );
